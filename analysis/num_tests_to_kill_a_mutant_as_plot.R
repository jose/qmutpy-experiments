...
p <- ggplot(df, aes(x=operator, y=number_of_tests_executed, fill=number_of_tests_executed)) + geom_boxplot()
# Facets
...
plot_label('Distribution as boxplot\nper target')
# Basic box plot with colors by groups
p <- ggplot(df, aes(x=short_target, y=number_of_tests_executed, fill=number_of_tests_executed)) + geom_boxplot()
# Facets
